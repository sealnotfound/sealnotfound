...
### Як +430–450% перетворилися приблизно на +80%

Графік показує, як умовні 100 доларів перетворилися на 530–550 доларів до липневого просідання, а після падіння на 67% залишилося 175–182 долари.

![Як плюс 430–450 відсотків перетворилися приблизно на плюс 80 відсотків](/images/situational-awareness-return-math-en.svg)

<p><small class="text-sm text-zinc-500 dark:text-zinc-400 italic">Джерело розрахунку: наданий лист партнерам. Автентичність документа незалежно не підтверджена; показники попередні та неаудійовані.</small></p>
