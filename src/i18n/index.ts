...
export const ui = {
  ru: {
    ...
    'nav.articles': 'Статьи',
    'nav.search': 'Поиск',
    'home.bio': 'Заметки о фьючерсах, геополитике и трейдинге в реальном мире.',
  ...
  en: {
    ...
    'nav.search': 'Search',
    'home.bio': 'Market notes on futures, geopolitics, and real-world trading.',
  ...
  uk: {
    ...
    'nav.articles': 'Статті',
    'nav.search': 'Пошук',
    'home.bio': 'Нотатки про ф\'ючерси, геополітику та трейдинг у реальному світі.',
  ...
  de: {
    ...
    'nav.search': 'Suche',
    'home.bio': 'Notizen zu Futures, Geopolitik und Trading in der Praxis.',
